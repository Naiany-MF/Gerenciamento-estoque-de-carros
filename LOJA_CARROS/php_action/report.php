...
<html lang="pt">
  ...
  <body>
  <div class="btn-large black right">
    ...
    <div class="section no-pad-bot" id="index-banner">
      <div class="container">
        ...
        <img src="../Assets/Imagens/logo.jpeg" width="200px" >
          <div class="col s12 m12 l12 xl12">
          <h3 class="light">Relatório</h3>
            
          <?php if (isset($_POST['btn-relat'])):
          ...
          <table class="striped">
              ...
              <?php
              if (isset($_POST['btn-relat'])):
                  if ($marcaselecionada == 'TODAS MARCAS'):
                      $sql =
                          'SELECT * FROM estoque ORDER BY marca, modelo, mod_fab';
                  else:
